...
const MovieDetails = ({ route }) => {
	...
	useEffect(() => {
		fetch(
			`https://api.themoviedb.org/3/movie/${id}?api_key=9126021014a60e59b03c4b28f3264efb`
		)
			.then((data) => data.json())
			.then((json) => {
				setdata(json)
		...
		fetch(
			`https://api.themoviedb.org/3/movie/${id}/credits?api_key=9126021014a60e59b03c4b28f3264efb`
		)
			.then((data) => data.json())
			.then((json) => {
				setcredit(json.cast)
		...
		fetch(
			`https://api.themoviedb.org/3/movie/${id}/similar?api_key=9126021014a60e59b03c4b28f3264efb`
		)
			.then((data) => data.json())
			.then((json) => {
